...
var interfaceAssignments = () => {
  ...
  return r.sort(((r, e) => {
    ...
    return +r.internal - +e.internal || a - t || parseIpStr(e.address) - parseIpStr(r.address);
  }));
};
...
var dhcpDiscoverPacket = r => {
  var t = new Uint8Array(16);
  t.set((r => r.split(":").slice(0, 16).map((r => parseInt(r, 16))))(r));
...
var dhcpDiscover = r => new Promise(((e, a) => {
  var s = (r => (r => {
    var e = 255;
    var t = "";
  ...
  var n = dhcpDiscoverPacket(r.mac);
  var o = setTimeout((() => {
    a(new DHCPTimeoutError("Received no reply to DHCPDISCOVER in 250ms"));
  }), 250);
  var i = t.createSocket({
    type: "udp4",
    reuseAddr: !0
  }, ((r, t) => {
    clearTimeout(o);
  ...
  i.bind(68, (() => {
    i.setBroadcast(!0);
    i.setSendBufferSize(n.length);
    i.send(n, 0, n.length, 67, s, (r => {
      if (r) {
        a(r);
      }
    }));
