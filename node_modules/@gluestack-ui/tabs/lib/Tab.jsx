...
export const Tab = (StyledTab) => memo(forwardRef(({ value, children, ...props }, ref) => {
    ...
    return (<StyledTab accessiblityRole="tab" ref={ref} states={{
            hover: isHovered,
            focus: isFocused,
        ...
        }} tabIndex={value === currentActiveTab ? 0 : -1} {...props} onPressIn={composeEventHandlers(props?.onPressIn, pressProps.onPressIn)} onPressOut={() => onChange(value)} onPress={composeEventHandlers(props?.onPress, pressProps.onPress)} 
    // @ts-ignore - web only
    ...
    // @ts-ignore - web only
    onBlur={composeEventHandlers(composeEventHandlers(props?.onBlur, focusProps.onBlur), focusRingProps.onBlur)} {...tabProps}>
